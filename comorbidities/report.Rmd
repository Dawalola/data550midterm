...
the prevalence of COPD within each age group. It helps visualize how the prevalence of COPD varies across different age categories, providing insights into the relationship between age and COPD in COVID patients
```{r}
...
The distribution of people to with COVID with diabetes and likelihood of ICU admission to check disease severity.
```{r}
